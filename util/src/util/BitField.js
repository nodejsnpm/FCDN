...
class BitField {
    ...
    *[Symbol.iterator]() {
    ...
    static resolve(bit = BigInt(0)) {
        var _a, _b;
        // @ts-ignore
        const FLAGS = this.FLAGS || ((_a = this.constructor) === null || _a === void 0 ? void 0 : _a.FLAGS);
        ...
        if (Array.isArray(bit)) {
            // @ts-ignore
            const resolve = ((_b = this.constructor) === null || _b === void 0 ? void 0 : _b.resolve) || this.resolve;
